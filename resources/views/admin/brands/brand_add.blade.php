            ...
            <div class="col-md-12">
               <div class="card card-primary">
                  <div class="card-header">
                     ...
                     <a href="{{url('admin/brands')}}" class="btn btn-success float-right"><i class="fa fa-list"></i> List Brand</a>
                  </div>
                  @if($errors->any())
                  ...
                  <form action="{{url('admin/store-brand')}}" method="post" enctype="multipart/form-data">
                    @csrf
                     <div class="card-body">
                        <div class="row">
