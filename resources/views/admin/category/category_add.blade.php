                       ...
                       <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="parent_id" id="parent_id">
                                    ...
                                    @foreach($gatCategories as $category)
                                        <option value="{{ $category->id }}">{{ $category->category_name }}</option>
                                        @foreach($category->nestedSubCategories as $subcategory)
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="category_url" id="category_url" placeholder="Category Url">
                        </div>      
                        </div> 
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="category_discount" class="form-control" id="category_discount" placeholder="Category Discount">
                        </div>                              
                        </div>
                        <div class="col-lg-12">
                        <div class="form-group">
                           <label for="category_discription">Category Discription</label>
                           <textarea id= "summernote" name="category_discription" class="form-control"></textarea>
                        </div>                              
                        </div>                       
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="category_meta_title" class="form-control" id="category_meta_title" placeholder="Category Meta Title">
                        </div>                              
                        </div>                        
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="category_meta_description" class="form-control" id="category_meta_description" placeholder="Category Meta Description">
                        </div>                              
                        </div> 
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="category_meta_keyword" class="form-control" id="category_meta_keyword" placeholder="Category Meta Keyword">
                        </div>                              
                        </div> 
